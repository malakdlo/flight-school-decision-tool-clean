...
- **v2.2 — 2026-07-10 (post sign-off, owner-directed):** Towered inbound "Position report" (T10) and "Traffic in sight" (T9) removed as standalone steps — they are conditional, so their phraseology now lives in the tower check-in step's "Possible alternatives" list (wording unchanged from the signed-off templates). Outbound default operation selection is now taxi / takeoff / leaving the area (pattern opt-in). No phraseology changes.
